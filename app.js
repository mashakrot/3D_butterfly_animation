...
topLight.position.add(new THREE.Vector3(500, 500, 500));
scene.add(topLight);
...
let arrPositionModel = [
    ...
    },
    {
        ...
        position: { x: 3.5, y: 0.2, z: -5 },
        rotation: { x: -0.5, y: -0.7, z: 0 },
    },
    {
        id: "description",
        // position: { x: -1, y: -1, z: -5 },
        position: { x: -3.5, y: -1.2, z: -5 },
        rotation: { x: -0.7, y: 0.9, z: 0 },
    },
    {
        id: "contact",
...
const modelMove = () => {
    ...
    sections.forEach((section) => {
        ...
        if (rect.top <= window.innerWidth / 3) {
